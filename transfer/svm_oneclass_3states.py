...
path_task1 = f'./friction_0_8/model/'
path_task2 = f'./friction_0_3/model2/'


with open(f'{path_task1}/seq_states_500e.pkl', 'rb') as f:
    seq_states_t1 = pickle.load(f)

with open(f'{path_task2}/seq_states_500e.pkl', 'rb') as f:
...
# nu = [10e-4, 10e-3, 10e-2]
# kernel = ['poly']
# degree = [2,3,4,5]
# gamma = [10e-5, 10e-4, 10e-3, 10e-2]
...
Xtrain.append(dataset_task1[0:int(0.6*dataset_task1.shape[0])])
